...
class SIYIRTSP:
    def __init__(self, rtsp_url="rtsp://192.168.144.25:8554/main.265", cam_name="a8_mini", debug=True) -> None:
        '''
        ...
        self._out = cv2.VideoWriter('output.mp4',fourcc, 10.0, (self._width,self._height))
