...
class GimbalController:
    ...
    def run(self):
        print("Controllo YAW & PITCH da RC (CH12 = YAW, CH13 = PITCH)...")
        while True:
            ...
            if msg:
                ...
                if (self.prev_yaw is None or abs(yaw - self.prev_yaw) > 0.5 or
                    self.prev_pitch is None or abs(pitch - self.prev_pitch) > 0.5):
